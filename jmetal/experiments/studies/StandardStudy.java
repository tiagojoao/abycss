...
import jmetal.problems.SSpamProblem2DAbYCSS;
...
public class StandardStudy extends Experiment {
  ...
  public void algorithmSettings(String problemName, 
    ...
    try {
      ...
      if (!paretoFrontFile_[problemIndex].equals("")) {
        ...
        algorithm[0] = new NSGAIIPermutation_Settings("SSpamProblem2D").configure(parameters[0]);
        algorithm[1] = new AbYCSS_Settings("SSpamProblem2DAbYCSS").configure(parameters[1]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    exp.experimentBaseDirectory_ = //"/Users/tiagoinacio/ownCloud/htdocs/git/jmetal/" +
									"./" +
                                   exp.experimentName_;
    exp.paretoFrontDirectory_ = //"//Users/tiagoinacio/ownCloud/htdocs/git/jmetal/paretoFronts";
									"./";
