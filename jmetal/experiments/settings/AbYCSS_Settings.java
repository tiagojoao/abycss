...
/**
 * Settings class of algorithm AbYCSS
 */
public class AbYCSS_Settings extends Settings {
   ...
   */
  public AbYCSS_Settings(String problemName) {
    super(problemName);
  ...
  /**
   * Configure the AbYCSS algorithm with default parameter experiments.settings
  ...
  /**
   * Configure AbYCSS with user-defined parameter experiments.settings
   * @return An AbYCSS algorithm object
   */
  @Override
