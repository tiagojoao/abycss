...
/**
 * This class is the main program used to configure and run AbYCSS, a 
...
public class AbYCSS_main {
  ...
  public static void main(String [] args) throws 
    ...
    fileHandler_ = new FileHandler("AbYCSS.log"); 
    ...
    if (args.length == 1) {
      ...
      problem = new ZDT4("SSpamProblem2D", 10);
      //problem = new ConstrEx("Real");
      //problem = new DTLZ1("Real");
      //problem = new OKA2("Real") ;
    } // else
   
    // STEP 2. Select the algorithm (AbYCSS)
    algorithm = new AbYCSS(problem) ;
